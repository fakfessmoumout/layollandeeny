  ...
  <body>
            ...
            <div class="col-md-12">
                <?php 
                        ...
                        if(isset($_GET['err'])){
                            ...
                            switch($err){
                                case 'current_pseudo':
                                    echo "<div class='alert alert-danger'>Le pseudo actuel est incorrect</div>";
                                break;

                                case 'success_pseudo':
                                    echo "<div class='alert alert-success'>Le pseudo a bien été modifié ! </div>";
                                break; 
                            }
                        }
                    ?>
                ...
                <div class="text-center">
                        <h1 class="p-5">Paramètres de <?php echo $data['pseudo']; ?> !</h1>
                        <a class='one' href='EducTom.php'>Acceuil</a>
                        <hr />
                        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#change_pseudo">
                          Modifier mon pseudo
                        </button>
                        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#change_email">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Modifier mon pseudo</h5>
            ...
            <div class="col-md-12">
                <?php 
                        if(isset($_GET['err'])){
                            ...
                            switch($err){
                                case 'current_email':
                                    echo "<div class='alert alert-danger'>L'adresse email actuel est incorrect</div>";
                                break;

                                case 'success_email':
                                    echo "<div class='alert alert-success'>L'adresse email a bien été modifié ! </div>";
                                break; 
                            }
                        }
                    ?>
        ...
        <div class="modal fade" id="change_email" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Modifier mon adresse email</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                         </div>
                            <div class="modal-body">
                                <form action="change_email.php" method="POST">
                                    <label for='current_email'>Adresse email actuel</label>
                                    ...
                                    <br />
                                    <label for='new_email_retype'>Re tapez la nouvelle adresse email</label>
